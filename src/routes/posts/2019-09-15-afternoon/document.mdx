...
Anyway, the sound of the guitars sounded good enough to make the crowd jump.
...
It took me the most time to get the 3rd string to replace that.
...
The music show ends with biggest hit of CHH -> "Tầng Thượng 102"
